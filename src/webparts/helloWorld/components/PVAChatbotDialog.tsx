...
export const PVAChatbotDialog = (props: IChatbotProps) => {
  ...
  const botURL =
    "https://6a0383e2ebc3ee40bdc9d05198285a.12.environment.api.powerplatform.com/powervirtualagents/botsbyschema/crfb3_selfServiceAgent/directline/token?api-version=2022-03-01-preview";
  ...
  const handleLayerDidMount = async () => {
    ...
    // );
    const MSALWrapperInstance = new MSALWrapper(
      "4ffd1a7a-9a30-48a9-bc3d-51060e46591b",
      "api://27eb69cb-53e6-40db-8533-dfa804dca4ac/Sites.Read",
    );
...
export default PVAChatbotDialog;
